...
case 'anal':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random2/anal?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'ecchi':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random/nsfw/ecchi?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
let cita = res[Math.floor(Math.random() * res.length)]
          ...
          conn.sendButton(m.chat, tekk, fot, cita, [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'holoero':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random/nsfw/holo?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'eroyuri':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random/nsfw/eroYuri?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'feet':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random2/feet?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'futanari':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random2/futanari?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'holo':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random2/hololewd?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'milf':
         ...
         if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random/nsfw/milf?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'oppai':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random/nsfw/sideoppai?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
...
case 'yaoi':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch('https://api.lolhuman.xyz/api/random2/yaoi?apikey=SGWN')).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
